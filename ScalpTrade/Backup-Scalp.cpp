...
//	}
//	//else {
//	//	//cout << "reached Else block 1 in Process QUote : " << (static_cast<int>(newQuote->bidPrice)) << '\n';
//	//	//cout << "reached Else block for vwap in Process QUote : " << (vwap) << '\n';
//	//	//cout << "reached Else block 3 in Process QUote : " << (static_cast<int>(newQuote->bidPrice) < vwap) << '\n';
//	//}
//}
//
//void processTrade(Trade* newTrade, int const& vwapWindow) {
...
//	//cout << "vwap_numerator : " << vwap_numerator  << '\n';
//	//cout << "vwap_denominator : " << vwap_denominator << '\n';
//	//cout << " VWap : " << vwap <<'\n';
//	vwapFlag = true;
